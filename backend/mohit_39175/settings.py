"""
Django settings for mohit_39175 project.
...
WSGI_APPLICATION = 'mohit_39175.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mohit_39175 API",
    "DESCRIPTION": "API documentation for mohit_39175 App",
    "VERSION": "v1",
}
